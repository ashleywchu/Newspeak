...
def make_tags
	ActsAsTaggableOn::Tag.create(:name => "CharterSchools")
	ActsAsTaggableOn::Tag.create(:name => "TPP")
	ActsAsTaggableOn::Tag.create(:name => "WikiLeaks")
	ActsAsTaggableOn::Tag.create(:name => "Occupy")
	ActsAsTaggableOn::Tag.create(:name => "AllDayAllWeek")
	ActsAsTaggableOn::Tag.create(:name => "99percent")
	ActsAsTaggableOn::Tag.create(:name => "1percent")
	ActsAsTaggableOn::Tag.create(:name => "Egypt")
	ActsAsTaggableOn::Tag.create(:name => "ArabSpring")
	ActsAsTaggableOn::Tag.create(:name => "Energy")
	ActsAsTaggableOn::Tag.create(:name => "Science")
	ActsAsTaggableOn::Tag.create(:name => "Astronomy")
	ActsAsTaggableOn::Tag.create(:name => "Racism")
	ActsAsTaggableOn::Tag.create(:name => "Detroit")
	ActsAsTaggableOn::Tag.create(:name => "Tragedy")
	ActsAsTaggableOn::Tag.create(:name => "PoliceThePolice")
	ActsAsTaggableOn::Tag.create(:name => "Battery")
	ActsAsTaggableOn::Tag.create(:name => "Nanoparticles")
	ActsAsTaggableOn::Tag.create(:name => "RenewableEnergy")
	ActsAsTaggableOn::Tag.create(:name => "Puppy")
	ActsAsTaggableOn::Tag.create(:name => "Research")
	ActsAsTaggableOn::Tag.create(:name => "LithiumIon")
	ActsAsTaggableOn::Tag.create(:name => "Oxytocin")
	ActsAsTaggableOn::Tag.create(:name => "Yale")
	ActsAsTaggableOn::Tag.create(:name => "Harvard")
	ActsAsTaggableOn::Tag.create(:name => "ColumbiaUniversity")
	ActsAsTaggableOn::Tag.create(:name => "ElectricalEngineering")
	ActsAsTaggableOn::Tag.create(:name => "Capacitor")
	ActsAsTaggableOn::Tag.create(:name => "Lithium")
	ActsAsTaggableOn::Tag.create(:name => "EV")
	ActsAsTaggableOn::Tag.create(:name => "GlobalWarming")
	ActsAsTaggableOn::Tag.create(:name => "ClimateChange")
	ActsAsTaggableOn::Tag.create(:name => "Ecology")
	ActsAsTaggableOn::Tag.create(:name => "Biology")
	ActsAsTaggableOn::Tag.create(:name => "Dolphins")
	ActsAsTaggableOn::Tag.create(:name => "MarineBio")
	ActsAsTaggableOn::Tag.create(:name => "Anthropomorphism")
	ActsAsTaggableOn::Tag.create(:name => "Cetaceans")
	ActsAsTaggableOn::Tag.create(:name => "Transgender")
	ActsAsTaggableOn::Tag.create(:name => "LGBTQ")
	ActsAsTaggableOn::Tag.create(:name => "HumanRights")
	ActsAsTaggableOn::Tag.create(:name => "Orientalism")
	ActsAsTaggableOn::Tag.create(:name => "EdSaid")
	ActsAsTaggableOn::Tag.create(:name => "SpaceTelescope")
	ActsAsTaggableOn::Tag.create(:name => "Spitzer")
	ActsAsTaggableOn::Tag.create(:name => "Obama")
	ActsAsTaggableOn::Tag.create(:name => "AffordableHealthcareAct")
	ActsAsTaggableOn::Tag.create(:name => "HolographicUniverse")
	ActsAsTaggableOn::Tag.create(:name => "BlackHole")
	ActsAsTaggableOn::Tag.create(:name => "Supernova")
	ActsAsTaggableOn::Tag.create(:name => "NeilDegrasseTyson")
	ActsAsTaggableOn::Tag.create(:name => "Saganism")
	ActsAsTaggableOn::Tag.create(:name => "Shulginism")
	ActsAsTaggableOn::Tag.create(:name => "Marijuana")
	ActsAsTaggableOn::Tag.create(:name => "Legalization")
	ActsAsTaggableOn::Tag.create(:name => "WarOnDrugs")
	ActsAsTaggableOn::Tag.create(:name => "NSA")
	ActsAsTaggableOn::Tag.create(:name => "BlackOps")
	ActsAsTaggableOn::Tag.create(:name => "CIA")
	ActsAsTaggableOn::Tag.create(:name => "Hashtag")
	ActsAsTaggableOn::Tag.create(:name => "ETSY")
	ActsAsTaggableOn::Tag.create(:name => "IPO")
	ActsAsTaggableOn::Tag.create(:name => "WallSt")
	ActsAsTaggableOn::Tag.create(:name => "NoFrackingWay")
	ActsAsTaggableOn::Tag.create(:name => "Fracking")
	ActsAsTaggableOn::Tag.create(:name => "Pipeline")
	ActsAsTaggableOn::Tag.create(:name => "GMO")
	ActsAsTaggableOn::Tag.create(:name => "BigOil")
	ActsAsTaggableOn::Tag.create(:name => "MoneyInPolitics")
	ActsAsTaggableOn::Tag.create(:name => "Lobbying")
	ActsAsTaggableOn::Tag.create(:name => "Beltway")
	ActsAsTaggableOn::Tag.create(:name => "PorkBarrel")
	ActsAsTaggableOn::Tag.create(:name => "Education")
	ActsAsTaggableOn::Tag.create(:name => "Teachers")
	ActsAsTaggableOn::Tag.create(:name => "Children")
	ActsAsTaggableOn::Tag.create(:name => "PublicSchools")
	ActsAsTaggableOn::Tag.create(:name => "Primates")
