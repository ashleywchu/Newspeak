...
def make_users
	User.create(:name => "Shawn", :email => "shawn@awesome.com", :article_rep => 1000, :comment_rep => 500, :uid => "104598241683157696733", :provider => "google_oauth2")
	...
	User.create(:name => "Sanj", :email => "sjchakrav@gmail.com", :article_rep => 99999, :comment_rep => 99999, :uid => "104583935941508057228", :provider => "google_oauth2")
...
1:20 a.m. Police are bringing in bulldozers.", :rep => 10, :author_id => 2, :tag_list => "NYPD, Wall Street, Riot, Police, Occupy")
...
Comrades from Cairo
13 November, 2011", :rep => 5, :author_id => 2, :tag_list => "Occupy, Egypt")
...
def make_taggings
	Tagging.create(:taggable_id => 1, :tag_id => 2, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 1, :tag_id => 4, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 1, :tag_id => 5, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 1, :tag_id => 6, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 1, :tag_id => 7, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 2, :tag_id => 2, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 2, :tag_id => 8, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 2, :tag_id => 9, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 2, :tag_id => 60, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 3, :tag_id => 2, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 3, :tag_id => 70, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 3, :tag_id => 71, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 3, :tag_id => 72, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 3, :tag_id => 69, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 5, :tag_id => 1, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 4, :tag_id => 73, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 4, :tag_id => 74, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 4, :tag_id => 75, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 5, :tag_id => 16, :tagger_id => 4, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 5, :tag_id => 41, :tagger_id => 4, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 5, :tag_id => 56, :tagger_id => 4, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 5, :tag_id => 75, :tagger_id => 4, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 6, :tag_id => 16, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 6, :tag_id => 56, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 6, :tag_id => 75, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 7, :tag_id => 27, :tagger_id => 1, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 7, :tag_id => 28, :tagger_id => 1, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 7, :tag_id => 29, :tagger_id => 1, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 7, :tag_id => 30, :tagger_id => 1, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 7, :tag_id => 21, :tagger_id => 1, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 7, :tag_id => 22, :tagger_id => 1, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 8, :tag_id => 27, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 8, :tag_id => 28, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 8, :tag_id => 29, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 8, :tag_id => 30, :tagger_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 9, :tag_id => 20, :tagger_id => 4, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 9, :tag_id => 11, :tagger_id => 4, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 9, :tag_id => 34, :tagger_id => 4, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 10, :tag_id => 34, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 10, :tag_id => 21, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 10, :tag_id => 11, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 10, :tag_id => 77, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 11, :tag_id => 34, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 11, :tag_id => 35, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 11, :tag_id => 36, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 11, :tag_id => 37, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 11, :tag_id => 38, :tagger_id => 3, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 12, :tag_id => 44, :tagger_id => 4, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 12, :tag_id => 48, :tagger_id => 4, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 12, :tag_id => 49, :tagger_id => 4, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 12, :tag_id => 50, :tagger_id => 4, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 12, :tag_id => 12, :tagger_id => 4, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 12, :tag_id => 11, :tagger_id => 4, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 13, :tag_id => 65, :tagger_id => 1, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 13, :tag_id => 66, :tagger_id => 1, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 13, :tag_id => 68, :tagger_id => 1, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 13, :tag_id => 69, :tagger_id => 1, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 13, :tag_id => 70, :tagger_id => 1, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 13, :tag_id => 71, :tagger_id => 1, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 13, :tag_id => 72, :tagger_id => 1, :tagger_type => "User", :taggable_type => "Article")
end
