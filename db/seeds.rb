...
def make_articles
	Article.create(:title => "Liberty Square Raided by NYPD", :abstract => "Liberty Square (Zuccotti Park), home of Occupy Wall Street for the past two months and birthplace of the 99% movement that has spread across the country and around the world, was evicted by a large police force on 11/15/11.", :sources => ["http://www.nycga.net/2011/11/liberty-square-being-raided-by-nypd/", "http://www.youtube.com/watch?v=X2ZMkysoBXg[/youtube]", "http://www.youtube.com/watch?v=mhQCpXM-Sm4[/youtube]"], :body => "TIMELINE OF EVENTS:
		...
		1:20 a.m. Police are bringing in bulldozers.", :author_id => 2, :tag_list => "NYPD, Wall Street, Riot, Police, Occupy")
	...
	We have, all of us around the world, been learning new ways to represent ourselves, to speak, to live our politics directly and immediately, and in Egypt we did not set out to the streets in revolution simply to gain a parliament. Our struggle—which we think we share with you—is greater and grander than a neatly functioning parliamentary democracy; we demanded the fall of the regime, we demanded dignity, freedom and social justice, and we are still fighting for these goals. We do not see elections of a puppet parliament as the means to achieve them.
		...
		But even though the idea of election monitoring doesn’t really do it for us, we want your solidarity, we want your support and your visits. We want to know you, talk with you, learn one another’s lessons, compare strategies and share plans for the future. We think that activists or as people committed to serious change in the systems we live in, there is so much more that we can do together than legitimizing electoral processes (leave that boring job to the Carter Foundation) that seem so impoverished next to the new forms of democracy and social life we are building. It should be neither our job nor our desire to play the game of elections; we are occupying and we should build our spaces and our networks because they themselves are the basis on which we will build the new. Let us deepen our lines of communication and process and discover out what these new ways of working together and supporting one another could be.
			...
			Any time you do want to come over, we’ve got plenty of comfy couches available. It won’t be fancy, but it will be fun.
				...
				Comrades from Cairo
				13 November, 2011", :author_id => 2, :tag_list => "Occupy, Egypt")
				...
				Even more evidence of Success Academy’s ritual humiliation comes from Seaton Hall University education professor Daniel Katz. On his personal blog, he recalls a report from the New York Times in 2011 explaining that children who do not fit into the “very narrow mode” Success Academy enforces “find themselves subjected to excessive punishments and ongoing suggestions that they should leave.”
					...
					Calling this type of school environment humiliating is an understatement—perhaps as humiliating as the scene in Atlanta of educators in shackles being led from the courtroom. Except in this case, the humiliation is directed at little kids.
						...
						So yes, you can argue Success Academy’s kids are being cheated, too. In exchange for years of humiliation and mindless test prep, in stultifying conditions, without the rich, adventurous learning experiences enjoyed by their more well-to-do peers, they’re being given a chance to join the ranks of the college and career bound that seems no more assured—and could actually be worse—than what they faced to begin with.
							...
							Put that way, it does sound like cheating. And no one likes a cheater.", :author_id => 4, :tag_list => "CharterSchools, PublicSchools, Teachers, Education")
Article.create(:title => "NEWS & POLITICS
	...
	In January, Prosecutor Kym Worthy dismissed the case against the killer cop.
		...
		Why a man who admittedly murdered a sleeping child would ever want to stalk the streets with a weapon remains unclear.  Watch out Detroit, there is an armed monster roaming free.", :author_id => 3, :tag_list => "PoliceThePolice, Children, Tragedy")
Article.create(:title => "Police Cadet Quits Academy, Reports Cops After Witnessing Homeless Man Being Beaten By Officers", :abstract => "District Attorney Kari Brandenburg has provided new details in the case of two Albuquerque police officers who are under investigation for brutality after allegedly beating a homeless man on March 20. A police cadet reported the incident and has since resigned; since 2009, this department has been involved in 47 shootings, 32 of which were fatal. ", :sources => "http://www.alternet.org/police-cadet-quits-academy-reports-cops-after-witnessing-homeless-man-being-beaten-officers, http://www.alternet.org/police-cadet-quits-academy-reports-cops-after-witnessing-homeless-man-being-beaten-officers, http://www.alternet.org/police-cadet-quits-academy-reports-cops-after-witnessing-homeless-man-being-beaten-officers", :body => "Few details are known about what exactly transpired, and Police Chief Gorden Eden told KOAT that it is partly because he’s concerned for the safety of the cadet who reported the incident. Mayor Richard Berry says the fact that it was an employee shows there is a level of comfort and internal accountability within the department, as someone felt safe enough to come forward. However, the department is afraid for anyone to know the identity of the cadet – possibly implying that they do not even trust their own officers.
	...
	The only information shared by the chief came from a YouTube video posted to the department’s Facebook page. He stated that an internal affairs investigation was immediately launched and the Department of Justice, FBI, and US Attorney’s Office were also notified. The case is now being investigated by the state police. Since 2009, the troubled department has been involved in 47 shootings, 32 of which were fatal.  Chief Eden has stated that these numbers reflect a “systemic failure in our ability to track employee misconduct.”
		...
		While the APD may have lost a desperately needed actual “good cop”, the violent duo accused of the assault are currently on paid leave.", :author_id => 1, :tag_list => "PoliceThePolice")
Article.create(:title => "Better battery imaging paves way for renewable energy future", :abstract => "n a move that could improve the energy storage of everything from portable electronics to electric microgrids, researchers have developed a novel X-ray imaging technique to visualize and study the electrochemical reactions in lithium-ion rechargeable batteries containing a new type of material, iron fluoride.", :sources => "http://www.sciencedaily.com/releases/2015/04/150420182411.htm, University of Wisconsin-Madison, Journal Reference:
	...
	The synthesis of the battery materials in Jin's lab was supported by National Science Foundation Division of Materials Research.", :author_id => 2, :tag_list => "Battery, Science, Lithium, RenewableEnergy, Energy")
Article.create(:title => "Our Love Of Puppy Dog Eyes Explained By Science", :abstract => "Researchers found a spike in oxytocin occurs in both humans and dogs when they gaze into each other's eyes", :sources => "Newsy / Powered by NewsLook.com", :body => "See Video", :author_id => 4, :tag_list => "Puppy")
...
Article.create(:title => "Repeated marine predator evolution tracks changes in ancient and Anthropocene oceans", :abstract => "Scientists synthesized decades of scientific discoveries to illuminate the common and unique patterns driving the extraordinary transitions that whales, dolphins, seals and other species underwent as they moved from land to sea. Drawing on recent breakthroughs in diverse fields such as paleontology, molecular biology and conservation ecology, their findings offer a comprehensive look at how life in the ocean has responded to environmental change from the Triassic to the Anthropocene.", :sources => "http://www.sciencedaily.com/releases/2015/04/150416145547.htm, Smithsonian, Journal Reference:
	...
	In the case of deep divers such as beaked whales and seals, these species have independently evolved to have positively charged oxygen-binding proteins called myoglobin in their muscles, allowing them to survive underwater for long periods of time. Scientists also have found identical genetic sequences in different marine species, such as whales, seals and sea cows. Whether these invisible molecular similarities account for larger-scale visible patterns of convergent evolution, or whether convergent anatomy follows different genetic pathways in different groups, remains an important open question to be tackled as genomic sequences become available for more species.
		...
		Kelley and Pyenson synthesized research from existing studies and referenced the Smithsonians paleobiology collections during the course of their research. They intend that this comprehensive review will encourage future collaboration between researchers across scientific fields and lead to new insights about evolutionary biology, paleontology and marine conservation.", :author_id => 3, :tag_list => "Science, Biology, MarineBio, Dolphins")
		...
		\“PHMSA has always said, ‘We can’t,’\” the aide said. \“‘We can’t get it through [the White House budget office],’ ‘We can’t get the money,’ ‘We can’t get the resources,’ ‘We can’t submit what we really want,’ ‘We can’t regulate this,’ ‘We can’t get enough inspectors to do this.’ … PHMSA acts like it’s been beaten down for decades. Every time you try to offer a hand up, it almost retreats.\”
			...
			****
			...
			Stacey Gerard, a 20-year PHMSA veteran who retired as its chief safety officer, said public members of the advisory committees \“are not getting paid to do the research and reading\” that might empower them to play a more vocal role. \“Industry is going to be more dominant in the committee discussions because they’re usually more prepared and better armed.\”
				...
				PHMSA’s longest-serving chief, Cynthia Quarterman, said, in an interview with POLITICO, she was \“concerned\” about the advisory committee structure when she was appointed in 2009 by President Barack Obama. But Quarterman, a former industry lawyer who led the agency until October, came around to the concept \“because, if you could get them to agree across the board that what they’re doing makes sense, it makes a better case going forward.", :author_id => 1, :tag_list => "BigOil, Pipeline, Fracking, NoFrackingWay")
end

def make_tags
	Tag.create(:name => "CharterSchools", :taggings_count => 1)
	Tag.create(:name => "TPP", :taggings_count => 2)
	Tag.create(:name => "WikiLeaks", :taggings_count => 0)
	Tag.create(:name => "Occupy", :taggings_count => 1)
	Tag.create(:name => "AllDayAllWeek", :taggings_count => 1)
	Tag.create(:name => "99percent", :taggings_count => 1)
	Tag.create(:name => "1percent", :taggings_count => 1)
	Tag.create(:name => "Egypt", :taggings_count => 1)
	Tag.create(:name => "ArabSpring", :taggings_count => 1)
	Tag.create(:name => "Energy", :taggings_count => 0)
	Tag.create(:name => "Science", :taggings_count => 1)
	Tag.create(:name => "Astronomy", :taggings_count => 1)
	Tag.create(:name => "Racism", :taggings_count => 0)
	Tag.create(:name => "Detroit", :taggings_count => 0)
	Tag.create(:name => "Tragedy", :taggings_count => 0)
	Tag.create(:name => "PoliceThePolice", :taggings_count => 1)
	Tag.create(:name => "Battery", :taggings_count => 0)
	Tag.create(:name => "Nanoparticles", :taggings_count => 0)
	Tag.create(:name => "RenewableEnergy", :taggings_count => 1)
	Tag.create(:name => "Puppy", :taggings_count => 1)
	Tag.create(:name => "Research", :taggings_count => 1)
	Tag.create(:name => "LithiumIon", :taggings_count => 1)
	Tag.create(:name => "Oxytocin", :taggings_count => 0)
	Tag.create(:name => "Yale", :taggings_count => 0)
	Tag.create(:name => "Harvard", :taggings_count => 0)
	Tag.create(:name => "ColumbiaUniversity", :taggings_count => 0)
	Tag.create(:name => "ElectricalEngineering", :taggings_count => 1)
	Tag.create(:name => "Capacitor", :taggings_count => 1)
	Tag.create(:name => "Lithium", :taggings_count => 1)
	Tag.create(:name => "EV", :taggings_count => 1)
	Tag.create(:name => "GlobalWarming", :taggings_count => 0)
	Tag.create(:name => "ClimateChange", :taggings_count => 0)
	Tag.create(:name => "Ecology", :taggings_count => 0)
	Tag.create(:name => "Biology", :taggings_count => 1)
	Tag.create(:name => "Dolphins", :taggings_count => 1)
	Tag.create(:name => "MarineBio", :taggings_count => 1)
	Tag.create(:name => "Anthropomorphism", :taggings_count => 1)
	Tag.create(:name => "Cetaceans", :taggings_count => 1)
	Tag.create(:name => "Transgender", :taggings_count => 1)
	Tag.create(:name => "LGBTQ", :taggings_count => 0)
	Tag.create(:name => "HumanRights", :taggings_count => 0)
	Tag.create(:name => "Orientalism", :taggings_count => 1)
	Tag.create(:name => "EdSaid", :taggings_count => 0)
	Tag.create(:name => "SpaceTelescope", :taggings_count => 0)
	Tag.create(:name => "Spitzer", :taggings_count => 0)
	Tag.create(:name => "Obama", :taggings_count => 0)
	Tag.create(:name => "AffordableHealthcareAct")
	Tag.create(:name => "HolographicUniverse", :taggings_count => 1)
	Tag.create(:name => "BlackHole", :taggings_count => 1)
	Tag.create(:name => "Supernova", :taggings_count => 1)
	Tag.create(:name => "NeilDegrasseTyson", :taggings_count => 0)
	Tag.create(:name => "Saganism", :taggings_count => 0)
	Tag.create(:name => "Shulginism", :taggings_count => 0)
	Tag.create(:name => "Marijuana", :taggings_count => 0)
	Tag.create(:name => "Legalization", :taggings_count => 0)
	Tag.create(:name => "WarOnDrugs", :taggings_count => 1)
	Tag.create(:name => "NSA", :taggings_count => 0)
	Tag.create(:name => "BlackOps", :taggings_count => 0)
	Tag.create(:name => "CIA", :taggings_count => 0)
	Tag.create(:name => "Hashtag", :taggings_count => 1)
	Tag.create(:name => "ETSY", :taggings_count => 0)
	Tag.create(:name => "IPO", :taggings_count => 0)
	Tag.create(:name => "WallSt", :taggings_count => 0)
	Tag.create(:name => "NoFrackingWay", :taggings_count => 0)
	Tag.create(:name => "Fracking", :taggings_count => 1)
	Tag.create(:name => "Pipeline", :taggings_count => 1)
	Tag.create(:name => "GMO", :taggings_count => 0)
	Tag.create(:name => "BigOil", :taggings_count => 1)
	Tag.create(:name => "MoneyInPolitics", :taggings_count => 1)
	Tag.create(:name => "Lobbying", :taggings_count => 1)
	Tag.create(:name => "Beltway", :taggings_count => 1)
	Tag.create(:name => "PorkBarrel", :taggings_count => 1)
	Tag.create(:name => "Education", :taggings_count => 1)
	Tag.create(:name => "Teachers", :taggings_count => 1)
	Tag.create(:name => "Children", :taggings_count => 1)
	Tag.create(:name => "PublicSchools", :taggings_count => 0)
	Tag.create(:name => "Primates", :taggings_count => 1)
end

def make_comments
	Comment.create(:body => "Dude, sick!", :user_id => 3, :article_id => 12)
	Comment.create(:body => "NYPD: it's crucial that human rights be respected. Free speech is protected by the constitution, as well as the right to public assembly. Police, you are the 99% too!", :user_id => 2, :article_id => 1)
	Comment.create(:body => "I disagree with the previous user's comment, those occupiers should occupy jobs instead!", :user_id => 1, :article_id => 1)
	Comment.create(:body => "Scarcity of fairly paid jobs for college gradutates with rising student debt is one of the reasons occupy started. It's not like you can go to the supermarket and just take a job off the shelf on aisle 11 bro.", :user_id => 1, :article_id => 1)
	Comment.create(:body => "Occupy Everywhere!", :user_id => 3, :article_id => 2)
	Comment.create(:body => "Amazing how technology makes nonviolent revolution more possible than ever", :user_id => 1, :article_id => 2)
	Comment.create(:body => "TPP is being created in secret!!", :user_id => 3, :article_id => 3)
	Comment.create(:body => "How can multinationals legally create secret courts?", :user_id => 4, :article_id => 3)
	Comment.create(:body => "We have to stop the TPP", :user_id => 2, :article_id => 3)
	Comment.create(:body => "Can this be real?", :user_id => 4, :article_id => 4)
	Comment.create(:body => "It's real, follow the cited sources.", :user_id => 2, :article_id => 4)
	Comment.create(:body => "The TPP is being created without any knoweledge or consent of the public.", :user_id => 1, :article_id => 4)
	Comment.create(:body => "How can multinationals legally create secret courts?", :user_id => 3, :article_id => 4)
	Comment.create(:body => "We have to stop the TPP", :user_id => 3, :article_id => 4)
	Comment.create(:body => "This is horrible! I can't believe charter schools are getting away with this!", :user_id => 3, :article_id => 5)
	Comment.create(:body => "It's really unfortunate, especially as more and more public schools are closing.", :user_id => 2, :article_id => 5)
	Comment.create(:body => "I really like this column for always posting locally relevant news that features various perspectives.", :user_id => 1, :article_id => 5)
	Comment.create(:body => "Unbelievable! This guy shouldn't be allowed to be a cop anymore!", :user_id => 1, :article_id => 6)
	Comment.create(:body => "Smh. The callousness of the police chief is sadly representative of the attitudes of police forces everywhere. 'We shoot people, oh well, deal with it' is basically what they think.", :user_id => 1, :article_id => 6)
	Comment.create(:body => "I can't believe this happened while they were filming a reality tv show. wtf", :user_id => 3, :article_id => 6)
	Comment.create(:body => "But what about all of the times police get shot at? Don't they have a reason to be trigger happy?", :user_id => 1, :article_id => 6)
	Comment.create(:body => "Not if they are adequately trained. This officer clearly failed to accurately assess the situation, and murdered an unarmed child - with impunity no less. It isn't merely the difficulty of the position officers find themselves in, it's the total lack of accountability and nonchalant attitude towards the disproportionate power they yield.", :user_id => 2, :article_id => 6)
	Comment.create(:body => "This article has several problems. For starters it isn't specific enough. Also there is a lot of missing information. Please post more fact based reports.", :user_id => 2, :article_id => 7)
	Comment.create(:body => "It does name the police department though, which has a shockingly bad track record.", :user_id => 4, :article_id => 7)
	Comment.create(:body => "Police brutality and aggression are so ubiquitous. We need more psychological and mental health evaluations of these professionals. They are a danger to the very public they are sworn to protect!", :user_id => 3, :article_id => 7)
	Comment.create(:body => "SOME are, that's true, but my cousin is a cop and he's a really good guy, honest.", :user_id => 1, :article_id => 7)
	Comment.create(:body => "This is a really exciting development. Battery research is a critical link to a sustainable energy future.", :user_id => 5, :article_id => 8)
	Comment.create(:body => "This reminds me of the research being done at the Kaner lab at UCLA with graphene supercapacitators - really exciting stuff!", :user_id => 2, :article_id => 8)
	Comment.create(:body => "Wait, hasn't graphene been used as a coating for anodes and cathodes in batteries for some time now?", :user_id => 4, :article_id => 8)
	Comment.create(:body => "Yeah but the Kaner lab is working on figuring out how to use it as the energy storage medium rather than just a coating for the terminals.", :user_id => 2, :article_id => 8)
	Comment.create(:body => "Dude, sick bro. I can't wait for my flying car.", :user_id => 3, :article_id => 8)
	Comment.create(:body => "Awww look at the cute puppy!!!", :user_id => 1, :article_id => 9)
	Comment.create(:body => "It's amazing to think of all the biochemistry happening in our bodies at any given moment. Even just the physical contact from lightwaves bouncing off our eyes is a sufficient packet of information to trigger such an elaborate response in the biochemical software of our bodies.", :user_id => 2, :article_id => 9)
	Comment.create(:body => "Wow, that was really deep. Yeah oxytocin is insane", :user_id => 3, :article_id => 9)
	Comment.create(:body => "Proof that puppies are good for your health!", :user_id => 4, :article_id => 9)
	Comment.create(:body => "I'm amazed at how much we continue to learn from our primate cousins", :user_id => 4, :article_id => 10)
	Comment.create(:body => "This was a very interesting read, particularly the part about human beings having the most dexterity based on the calculations of their novel kinematic model.", :user_id => 2, :article_id => 10)
	Comment.create(:body => "I don't understand how there are still people that doubt evolution.", :user_id => 1, :article_id => 10)
	Comment.create(:body => "This is exactly the kind of interdisciplinary scientific research that needs to happen, and fortunately is happening more and more.", :user_id => 1, :article_id => 11)
	Comment.create(:body => "I love this article. Great insight into how evolution actually works as well. I wish they discussed the cetacean brain a little bit more - the cetacean brain is significantly more evolved than the human brain and it feels like no one is talking about this!", :user_id => 2, :article_id => 11)
	Comment.create(:body => "It's true, dolphins and killer whales have an entire additional cortex that humans don't have. It makes you wonder how/why that evolved, and whether they use it for cognition or just motor function.", :user_id => 2, :article_id => 11)
	Comment.create(:body => "Well, I wouldn't call it 'just motor function,' I mean, imagine what needs to happen in the brain of a dolphin in order to use echo location, and also have such intense auditory processing. They hear almost how we see.", :user_id => 3, :article_id => 11)
	Comment.create(:body => "Ashley ++", :user_id => 2, :article_id => 11)
	Comment.create(:body => "I wonder if this will be the key to fast as light (or maybe even faster than light) human space travel", :user_id => 4, :article_id => 12)
	Comment.create(:body => "Hah, maybe, but first we have to figure out how to travel thousands of lightyears towards the direction of the nearest black hole.", :user_id => 2, :article_id => 12)
	Comment.create(:body => "Thanks, but I prefer to stay as far away from a black hole as possible.", :user_id => 3, :article_id => 12)
	Comment.create(:body => "I really appreciate Newspeak for creating more fact based, decentralized and democratic citizen journalism!", :user_id => 4, :article_id => 13)
	Comment.create(:body => "Me too! It's really important, you would never see a story like this on CNN.", :user_id => 3, :article_id => 13)
	Comment.create(:body => "It's important to have a place for unpopular or unsponsored views to be expressed - it's one of the foundational principles of a healthy democracy.", :user_id => 2, :article_id => 13)
	Comment.create(:body => "True, but it's equally important to have accurate and reliable information.", :user_id => 1, :article_id => 13)
	Comment.create(:body => "Agreed, but that's why Newspeak features a reputation economy, so that the public can decide which content creators are reliable sources for accurate and well documented facts. By voting users columns up and down, the community self regulates. What other news source offers so much transparency and actual information?", :user_id => 2, :article_id => 13)
	Comment.create(:body => "Exactly. Our hope is that through using our platform, the quality of journalism can improve, but also the quality of critical thought, as the general public learns how to distinguish real info from hype, speculation, and propaganda.", :user_id => 2, :article_id => 13)
end

def make_taggings
	Tagging.create(:taggable_id => 1, :tag_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 1, :tag_id => 4, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 1, :tag_id => 5, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 1, :tag_id => 6, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 1, :tag_id => 7, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 2, :tag_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 2, :tag_id => 8, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 2, :tag_id => 9, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 2, :tag_id => 60, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 3, :tag_id => 2, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 3, :tag_id => 70, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 3, :tag_id => 71, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 3, :tag_id => 72, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 3, :tag_id => 69, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 5, :tag_id => 1, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 4, :tag_id => 73, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 4, :tag_id => 74, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 4, :tag_id => 75, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 5, :tag_id => 16, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 5, :tag_id => 41, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 5, :tag_id => 56, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 5, :tag_id => 75, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 6, :tag_id => 16, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 6, :tag_id => 56, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 6, :tag_id => 75, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 7, :tag_id => 27, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 7, :tag_id => 28, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 7, :tag_id => 29, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 7, :tag_id => 30, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 7, :tag_id => 21, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 7, :tag_id => 22, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 8, :tag_id => 27, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 8, :tag_id => 28, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 8, :tag_id => 29, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 8, :tag_id => 30, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 9, :tag_id => 20, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 9, :tag_id => 11, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 9, :tag_id => 34, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 10, :tag_id => 34, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 10, :tag_id => 21, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 10, :tag_id => 11, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 10, :tag_id => 77, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 11, :tag_id => 34, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 11, :tag_id => 35, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 11, :tag_id => 36, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 11, :tag_id => 37, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 11, :tag_id => 38, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 12, :tag_id => 44, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 12, :tag_id => 48, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 12, :tag_id => 49, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 12, :tag_id => 50, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 12, :tag_id => 12, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 12, :tag_id => 11, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 13, :tag_id => 65, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 13, :tag_id => 66, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 13, :tag_id => 68, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 13, :tag_id => 69, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 13, :tag_id => 70, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 13, :tag_id => 71, :tagger_type => "User", :taggable_type => "Article")
	Tagging.create(:taggable_id => 13, :tag_id => 72, :tagger_type => "User", :taggable_type => "Article")
end
